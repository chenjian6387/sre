...
![image-20220218204554523](/ajian/image-20220218204554523.png)

## IP地址

在网络不发达的时候，电脑数据是独立不共享的，两台机器传输数据可以通过数据线传输。

![image-20220218201836461](/ajian/image-20220218201836461.png)

如果是三台，或者更多的机器，要怎么插网线？

![image-20220218201904761](/ajian/image-20220218201904761.png)

那现在满世界的N台电脑，怎么进行数据交互呢，你怎么看到淘宝网的商品呢。

所有的机器都能够接入互联网，通过互联网互相转发数据。

![image-20220218202010121](/ajian/image-20220218202010121.png)
...
![image-20220218202805254](/ajian/image-20220218202805254.png)
...
![image-20220218203146211](/ajian/image-20220218203146211.png)

- 如果大楼A公司内部员工要发送数据资料，192.168.10.12只需发给192.168.10.11即可
- 如果大楼A公司某一个机器，要给大楼B公司的一个机器发数据，就得

![image-20220218203356096](/ajian/image-20220218203356096.png)
...
![image-20220218203901457](/ajian/image-20220218203901457.png)
...
![image-20220218204258808](/ajian/image-20220218204258808.png)
...
![image-20220218204904432](/ajian/image-20220218204904432.png)
...
![image-20220218210708473](/ajian/image-20220218210708473.png)

### 来玩一玩hosts文件

比如chaoge666.cn这个域名是不存在的。

![image-20220218211526906](/ajian/image-20220218211526906.png)

192.168.0.123这是你本地一个linux机器，是可以访问的。

![image-20220218211554589](/ajian/image-20220218211554589.png)
...
![image-20220218211704802](/ajian/image-20220218211704802.png)

ping检测域名解析。

![image-20220218211725151](/ajian/image-20220218211725151.png)

关于域名和IP解析关系。

![image-20220218211940955](/ajian/image-20220218211940955.png)
...
![image-20220218212154087](/ajian/image-20220218212154087.png)

### DNS劫持

![image-20220218212413252](/ajian/image-20220218212413252.png)
...
![image-20220219115347747](/ajian/image-20220219115347747.png)
...
![image-20220219133551231](/ajian/image-20220219133551231.png)
...
![image-20220219140035446](/ajian/image-20220219140035446.png)

------

![image-20220219140603334](/ajian/image-20220219140603334.png)

> DNS域名解析和手机号查询理解。

![image-20220219141035940](/ajian/image-20220219141035940.png)
...
![image-20220219145159578](/ajian/image-20220219145159578.png)
...
![image-20220219170535947](/ajian/image-20220219170535947.png)
...
![image-20220219182650222](/ajian/image-20220219182650222.png)

------

![image-20220219183241955](/ajian/image-20220219183241955.png)
...
![image-20220219183512258](/ajian/image-20220219183512258.png)
