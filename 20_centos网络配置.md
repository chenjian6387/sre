...
![image-20220124183824936](/ajian/image-20220124183824936.png)
...
![image-20220125093901114](/ajian/image-20220125093901114.png)

启用ens33

![image-20220125093937506](/ajian/image-20220125093937506.png)

### 临时设置网络接口(IP)

![image-20220125101302102](/ajian/image-20220125101302102.png)
...
![image-20220125101854319](/ajian/image-20220125101854319.png)

------

![image-20220125101947373](/ajian/image-20220125101947373.png)

> 可以reboot，重启机器后，再看看，IP信息
>
> 此时可以用新IP连接了。

![image-20220125102142782](/ajian/image-20220125102142782.png)
...
![image-20220125095955689](/ajian/image-20220125095955689.png)
...
![image-20220125100607398](/ajian/image-20220125100607398.png)
...
![image-20220125100924430](/ajian/image-20220125100924430.png)
...
![image-20220125103204725](/ajian/image-20220125103204725.png)

> 2.修改网卡配置文件

![image-20220125103458484](/ajian/image-20220125103458484.png)
...
![image-20220125104818746](/ajian/image-20220125104818746.png)

## 路由如何工作

![image-20220125110436613](/ajian/image-20220125110436613.png)
...
![image-20220125114654653](/ajian/image-20220125114654653.png)
...
![image-20220125115223803](/ajian/image-20220125115223803.png)

> 如果ping的是局域网10.96.0.146，直接从本地网卡ens33出去，因为存在路由。

![image-20220125115156722](/ajian/image-20220125115156722.png)

## 临时删除网关

![image-20220125115411534](/ajian/image-20220125115411534.png)

没有路由了，没有路线了，快递都不知道往哪送了、报错了呗。

![image-20220125115509639](/ajian/image-20220125115509639.png)
...
![image-20220125142759319](/ajian/image-20220125142759319.png)
...
![image-20220126095621057](/ajian/image-20220126095621057.png)

此时可以通过cmd里，使用telnet登录linux了。

![image-20220126095749123](/ajian/image-20220126095749123.png)

## tcpdump工具

我们已经可以通过telnet直接登录了，但是如果我们看不到背后的通信过程，一般只能从 1、命令执行结果 2、日志，这两个方面可以分析。

![image-20220126100332063](/ajian/image-20220126100332063.png)
...
![image-20220126100932775](/ajian/image-20220126100932775.png)

2.删除arp缓存，也就是删除ip和mac的这种解析记录

![image-20220126101257950](/ajian/image-20220126101257950.png)
...
![image-20220126102401566](/ajian/image-20220126102401566.png)

4.发送telnet请求，tcpdump能立即抓到网卡接收到的数据包。

![image-20220126102638711](/ajian/image-20220126102638711.png)
...
![image-20220126104608560](/ajian/image-20220126104608560.png)

> 2.客户端登录linux、telnet登录，输入你的账户密码

![image-20220126104652502](/ajian/image-20220126104652502.png)

> 3.关闭linux的tcpdump抓包。

![image-20220126104833085](/ajian/image-20220126104833085.png)

> 4.把该数据包，发送到windows里，用wireshark工具解析二进制数据。

### 安装wireshark

![image-20220126110614096](/ajian/image-20220126110614096.png)

传输通过tcpdump抓取的二进制数据，交给wireshark。

![image-20220126110651924](/ajian/image-20220126110651924.png)

> wireshark打开数据包文件。

![image-20220126111325372](/ajian/image-20220126111325372.png)

> 继续向下找，找到关于登录的选项

![image-20220126111503940](/ajian/image-20220126111503940.png)
...
![image-20220126111950307](/ajian/image-20220126111950307.png)

o

![image-20220126112044458](/ajian/image-20220126112044458.png)

o

![image-20220126112105328](/ajian/image-20220126112105328.png)

t

![image-20220126112143004](/ajian/image-20220126112143004.png)

#### 密码123456

开始传输密码了

![image-20220126112308362](/ajian/image-20220126112308362.png)

密码的数据包如下

![image-20220126112451481](/ajian/image-20220126112451481.png)

发现的确登录了服务器，也把登录期间的数据，账号，密码，全都拿到了，因此telnet是一个非常不安全的数据明文传输方式。

![image-20220126112602284](/ajian/image-20220126112602284.png)
